...
bool Scene::Start()
{
	...
	giant = new Planet(giantPos, 50.0f, 5, giantCol, { 2.0f, 2.0f }, 500, 442, 570, 0.1f, 0.1f);
	...
	newMoon = new Planet(newMoonPos, 50.0f, 7, newMoonCol, { 2.0f, 2.0f }, 100, 61, 160, 0.1f, 0.1f);
	...
	newHome = new Planet(newHomePos, 50.0f, 8, newHomeCol, { 2.0f, 2.0f }, 300, 231, 350, 0.1f, 0.1f);
